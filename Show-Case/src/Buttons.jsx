      ...
      <button onClick={()=>window.open("https://day-4-xi.vercel.app/" , "_blank")}className="btns">Day-4</button>
       <button onClick={()=>window.open("https://day-5-iota.vercel.app/" , "_blank")}className="btns">Day-5</button>
        <button onClick={()=>window.open("https://day-6-three-zeta.vercel.app/" , "_blank")}className="btns">Day-6</button>
         ...
         <button onClick={()=>window.open("https://day-13-black.vercel.app/" , "_blank")}className="btns">Day-13</button>
          <button onClick={()=>window.open("https://day-14-chi.vercel.app/" , "_blank")}className="btns">Day-14</button>
          <button onClick={()=>window.open("https://day-15-sigma.vercel.app/" , "_blank")}className="btns">Day-15</button>
          </div>
          </div>
          </div>
          </div>
